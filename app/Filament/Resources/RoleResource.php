...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    protected static ?string $navigationGroup = 'Manajemen Pengguna'; // Grup yang sama dengan User
    protected static ?string $navigationIcon = 'heroicon-o-shield-check'; // Ikon untuk peran
    protected static ?int $navigationSort = 2; // Urutan kedua setelah User
    protected static ?string $recordTitleAttribute = 'name'; // Gunakan 'name' sebagai judul
